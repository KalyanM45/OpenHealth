...
class ModelTrainerConfig:
    trained_model_file_path = os.path.join('Artifacts','Diabetes_Disease','Diabetes_Model.pkl')
...
class ModelTrainer:
    ...
    def initate_model_training(self,train_array,test_array):
        try:
            logging.info('Diabetes Disease Prediction: Splitting Dependent and Independent variables from train and test data')
            ...
            print(model_report)
            print('\n====================================================================================\n')
            logging.info(f'Diabetes Disease Prediction: Model Report: {model_report}')
            ...
            print(f'Diabetes Disease Prediction: Best Model Found, Model Name: {best_model_name}, Accuracy Score: {best_model_score}')
            print('\n====================================================================================\n')
